...
from rflib.utils import check_file_exist, is_str, mkdir_or_exist
...
def imread(img_or_path, flag='color', channel_order='bgr', backend=None):
    ...
    Args:
        ...
        backend (str | None): The image decoding backend type. Options are
            ...
            ``rflib.use_backend()`` will be used. Default: None.
...
def imfrombytes(content, flag='color', channel_order='bgr', backend=None):
    ...
    Args:
        ...
        backend (str | None): The image decoding backend type. Options are
            ...
            global imread_backend specified by ``rflib.use_backend()`` will be
            used. Default: None.
